  ...
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <form action="" @submit.prevent="submitForm" class="mx-auto mb-0 mt-12 max-w-md space-y-4">
      ...
      <div>
        ...
        <div class="relative">
          <input type="text" class="w-full rounded-lg border-gray-200 p-4 mt-5 pe-12 text-sm shadow-sm" v-model="name"
      ...
      <div v-if="selectedProjectTypeObject && Object.values(selectedProjectTypeObject)[0] === 'SequenceLabeling'">
        <div class="relative">
          <div class="flex items-center">
            ...
            <label for="checkbox-1" class="text-l ml-3 mt-5 font-medium text-gray-900">Count grapheme clusters as one
              character</label>
      ...
      selectedProjectTypeObject && Object.values(selectedProjectTypeObject)[0] === 'IntentDetectionAndSlotFilling'">
        <div class="relative">
          <div class="flex items-center">
            <input id="checkbox-1" aria-describedby="checkbox-1" type="checkbox"
              class="bg-gray-50 border-gray-300 mt-5 focus:ring-3 focus:ring-blue-300 h-5 w-5 rounded" checked="false"
              v-model="allowMemberToCreateLabelType">
            <label for="checkbox-1" class="text-l ml-3 mt-5 font-medium text-gray-900">Allow project members to create
              label
              types</label>
      ...
      <div>
        <div class="relative">
          <div class="flex items-center">
            ...
            <label for="checkbox-1" class="text-l ml-3 font-medium mt-5 text-gray-900">Share annotations across all
              users
            </label>
