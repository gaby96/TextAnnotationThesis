  ...
  <form action="" @submit.prevent="submitForm" class="mx-auto mb-0 mt-12 max-w-md space-y-4">
    ...
    <div>
      ...
      <div class="relative">
        <input
          type="text"
          class="w-full rounded-lg border-gray-200 p-4 mt-5 pe-12 text-sm shadow-sm"
          v-model="name"
    ...
    <div>
      ...
      <div class="relative">
        <input
          type="text"
          class="w-full rounded-lg border-gray-200 mt-5 p-4 pe-12 text-sm shadow-sm"
      ...
      <div>
        <div class="flex flex-wrap  mt-5 items-center gap-2">
          <template v-for="(tag, index) in selectedTags">
            <span class="flex items-center gap-2 rounded-full bg-blue-100 px-3 py-1 text-sm mt-5 text-blue-800">
              {{ tag.text }}
              <button
                type="button"
    ...
    <div v-if="selectedProjectTypeObject && Object.values(selectedProjectTypeObject)[0] === 'DocumentClassification'">
        <div class="relative">
            <div class="flex items-center">
                    ...
                    >
                    <label for="checkbox-1" class="text-l ml-3 mt-5 font-medium text-gray-900">Allow single label</label>
      ...
      <div v-if="selectedProjectTypeObject && Object.values(selectedProjectTypeObject)[0] === 'SequenceLabeling'">
          <div class="relative">
              <div class="flex items-center">
                      ...
                      >
                      <label for="checkbox-1" class="text-l ml-3 mt-5 font-medium text-gray-900">Allow overlapping spans</label>
        ...
        <div v-if="selectedProjectTypeObject && Object.values(selectedProjectTypeObject)[0] === 'SequenceLabeling'">
          <div class="relative">
              <div class="flex items-center">
                      ...
                      >
                      <label for="checkbox-1" class="text-l ml-3 mt-5 font-medium text-gray-900">Use relation labeling</label>
      ...
      <div v-if="selectedProjectTypeObject && Object.values(selectedProjectTypeObject)[0] === 'SequenceLabeling'">
          <div class="relative">
              <div class="flex items-center">
                      ...
                      >
                      <label for="checkbox-1" class="text-l ml-3 mt-5 font-medium text-gray-900">Count grapheme clusters as one character</label>
        ...
        <div class="relative">
            <div class="flex items-center">
                    ...
                    id="checkbox-1"
                     ...
                     checked="false"
                     v-model="allowMemberToCreateLabelType"
                     >
                    <label for="checkbox-1" class="text-l ml-3 mt-5 font-medium text-gray-900">Allow project members to create label types</label>
    ...
    <div>
        <div class="relative">
            <div class="flex items-center">
                    ...
                    type="checkbox" 
                    class="bg-gray-50 border-gray-300 mt-5 focus:ring-3 focus:ring-blue-300 h-5 w-5 rounded"
                    v-model="enableSharingMode" 
                    checked="false">
                    <label for="checkbox-1" class="text-l ml-3 font-medium mt-5 text-gray-900">Share annotations across all users </label>

            </div>
        </div>
    </div>
    <div>
        <button type="submit" style="background-color: #047857; color: white;" class="w-full text-white hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 mt-5 py-2.5 text-center dark:hover:bg-green-700 dark:focus:ring-green-800">Create</button>
    </div>
  </form>
</div>
</template>
