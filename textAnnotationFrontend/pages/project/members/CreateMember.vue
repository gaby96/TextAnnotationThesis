        ...
        <div
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form @submit.prevent="registerUser" class="space-y-4 md:space-y-6" action="#">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-start">
                  <div class="flex items-center h-5">
                    <div class="flex items-center h-5">
                      <input id="annoteterms" aria-describedby="annoteterms" type="checkbox"
                        class="checkbox w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-green-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-green-600 dark:ring-offset-gray-800">
                    </div>
                  </div>
              ...
              <button type="submit" style="background-color: #047857;"
                class="w-full text-white hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:hover:bg-green-700 dark:focus:ring-green-800">Sign
                in</button>
  
              <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                Have an account yet? <a href="#" style="color: #047857;"
