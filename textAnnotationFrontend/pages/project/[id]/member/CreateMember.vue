        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form @submit.prevent="registerUser" class="space-y-4 md:space-y-6" action="#">
            ...
            <button type="submit" style="background-color: #047857;" @click="addUser()"
              class="w-full text-white hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:hover:bg-green-700 dark:focus:ring-green-800">Add
              user</button>
